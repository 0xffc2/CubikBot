...
import top.cubik65536.cubikbot.logic.QQLoginLogic;
import top.cubik65536.cubikbot.pojo.GroupMember;
...
import top.cubik65536.cubikbot.utils.QQSuperLoginUtils;
import top.cubik65536.cubikbot.utils.QQUtils;
...
public class QQLoginLogicImpl implements QQLoginLogic {
    ...
    public String groupLottery(QQLoginEntity qqLoginEntity, Long group) throws IOException {
        ...
        if (jsonObject.getInteger("ec").equals(0)) {
            ...
            else if ("".equals(jsonObject.getString("name")) || jsonObject.getString("name") == null)
                return "抱歉，没有抽到礼物！！";
    ...
    public String vipSign(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        switch (jsonObject.getInteger("ret")) {
            case 0:
                ...
                break;
            case 10601:
                sb.append("会员面板今天已经签到！\n");
                break;
            case 10002:
                sb.append("会员面板签到失败！请更新QQ！\n");
                break;
            case 20101:
                sb.append("会员面板签到失败，不是QQ会员！\n");
                break;
        }
        ...
        switch (jsonObject.getInteger("ret")) {
            case 0:
                ...
                break;
            case 10601:
                sb.append("会员电脑端今天已经签到！\n");
                break;
            case 10002:
                sb.append("会员电脑端签到失败！请更新QQ！\n");
                break;
        }
        ...
        switch (jsonObject.getInteger("ret")) {
            case 0:
                ...
                break;
            case 10601:
                sb.append("会员手机端今天已经签到！\n");
                break;
            case 10002:
                sb.append("会员手机端签到失败！请更新QQ！\n");
                break;
        }
        ...
        switch (jsonObject.getInteger("ret")) {
            case 0:
                ...
                break;
            case 10601:
                sb.append("会员积分今天已经签到！\n");
                break;
            case 10002:
                sb.append("会员积分签到失败！请更新QQ！\n");
                break;
        }
        jsonObject = OkHttpUtils.getJson("https://iyouxi3.vip.qq.com/ams3.0.php?_c=page&actid=23074&format=json&g_tk=" + gtk2, cookie);
        switch (jsonObject.getInteger("ret")) {
            case 0:
                sb.append("会员积分手机端签到成功！！\n");
                break;
            case 10601:
                sb.append("会员积分手机端今天已经签到！\n");
                break;
            case 10002:
                sb.append("会员积分手机端签到失败！请更新QQ！\n");
                break;
        }
    ...
    public String queryVip(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        if (jsonObject.getInteger("ret").equals(0)) {
            ...
            jsonArray.forEach(obj -> {
                ...
                else if (vipJsonObject.containsKey("upgrade_service_name"))
                    name = vipJsonObject.getString("upgrade_service_name");
    ...
    public String yellowSign(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        switch (jsonObject.getInteger("code")) {
            case 0:
                ...
                break;
            case -3000:
                sb.append("黄钻公众号签到失败！请更新QQ！");
                break;
            case -90002:
                sb.append("抱歉，您不是黄钻用户，签到失败");
                break;
            default:
                sb.append("黄钻今日已签到！");
        }
    ...
    public String qqVideoSign1(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        switch (jsonObject.getInteger("ret")) {
            case 0:
                return "腾讯视频会员签到成功";
            case -10006:
                return "腾讯视频会员签到失败，请更新QQ！";
            case -10019:
                return "您不是腾讯视频会员，签到失败！";
            default:
                return "腾讯视频会员签到失败，" + jsonObject.getString("msg");
        }
    }
            ...
            if (jsonObject.getInteger("ret").equals(0)) {
                switch (jsonObject.getJSONObject("data").getInteger("code")) {
                    ...
                    case 130002:
                        return "sVip打卡已报名！";
                    default:
                        return "sVip打卡报名失败，" + jsonObject.getString("msg");
                }
            ...
            if (jsonObject.getInteger("ret").equals(0)) {
                switch (jsonObject.getJSONObject("data").getInteger("code")) {
                    ...
                    case 100001:
                        return "sVip今日已打卡";
                    default:
                        return "sVip打卡失败，" + jsonObject.getString("msg");
                }
    ...
    public String bigVipSign(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        else if (jsonObject1.getInteger("ret") == -3000 && jsonObject2.getInteger("code") == -3000)
            return "大会员签到失败！请更新QQ！";
        else return "大会员签到失败！！";
    }
    ...
    public String qqMusicSign(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        switch (jsonObject.getInteger("retCode")) {
            case 0:
                sb.append(String.format("QQ音乐签到成功！获得积分：%s，签到天数：%s，总积分：%s",
                        jsonObject.getString("todayScore"), jsonObject.getString("totalDays"), jsonObject.getString("totalScore")));
                break;
            case 40001:
                sb.append("QQ音乐今日已签到！");
                break;
            case -13004:
                sb.append("QQ音乐签到失败！请更新QQ！");
                break;
            default:
                sb.append("QQ音乐签到失败！").append(jsonObject.getString("errMsg"));
        }
        ...
        switch (jsonObject.getInteger("retCode")) {
            case 0:
                sb.append(String.format("QQ音乐活动签到成功！已连续签到%s天，累计签到%s天",
                        jsonObject.getJSONObject("signInfo").getString("continuousDays"), jsonObject.getJSONObject("signInfo").getString("totalDays")));
                break;
            case 40004:
                sb.append("QQ音乐活动今日已签到！");
                break;
            case -13004:
                sb.append("QQ音乐签到失败！请更新QQ！");
                break;
        ...
        switch (jsonObject.getInteger("retCode")) {
            case 0:
                sb.append(String.format("QQ音乐分享成功！获得积分：%s天，签到天数：%s天，总积分:%s",
                        jsonObject.getString("todayScore"), jsonObject.getString("totalDays"), jsonObject.getString("totalScore")));
                break;
            case 40001:
                sb.append("QQ音乐今日已分享！");
                break;
            case 40002:
                sb.append("QQ音乐今日分享未完成！");
                break;
            case -13004:
                sb.append("QQ音乐分享失败！请更新QQ！");
                break;
            default:
                sb.append("QQ音乐分享失败！").append(jsonObject.getString("errMsg"));
                break;
        }
        jsonObject = OkHttpUtils.postJson(url,
        ...
        switch (jsonObject.getInteger("retCode")) {
            case 0:
                sb.append("QQ音乐电台锦鲤打卡成功！积分+").append(jsonObject.getString("score"));
                break;
            case 40001:
                sb.append("QQ音乐电台锦鲤已打卡！");
                break;
            case -13004:
                sb.append("QQ音乐电台锦鲤打卡失败！请更新QQ！");
                break;
            default:
                sb.append("QQ音乐电台锦鲤打卡失败！").append(jsonObject.getString("errMsg"));
                break;
        }
    ...
    public String gameSign(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        switch (jsonObject.getInteger("result")) {
            ...
            case 1000005:
                sb.append("游戏大厅签到失败！请更新QQ！\n");
                break;
            default:
                sb.append("游戏大厅签到失败！").append(jsonObject.getString("resultstr")).append("\n");
        }
        ...
        switch (jsonObject.getInteger("result")) {
            case 0:
                ...
                break;
            case 1000005:
                sb.append("游戏大厅2签到失败！请更新QQ！\n");
                break;
            default:
                sb.append("游戏大厅签到2失败！").append(jsonObject.getString("resultstr")).append("\n");
        }
        ...
        if (response.code() == 200) {
            ...
            switch (jsonObject.getInteger("ecode")) {
                ...
                case -120000:
                    sb.append("手Q游戏中心签到失败！请更新QQ！\n");
                    break;
                default:
                    sb.append("手Q游戏中心签到失败！\n");
            }
        } else response.close();
        ...
        switch (iRet) {
            ...
            case 1:
                ...
                break;
            default:
                sb.append("精品页游签到失败！").append(jsonObject.getString("sMsg"));
        }
        Map<String, String> map = new HashMap<>();
        ...
        if (jsonObject == null) sb.append("道聚城签到失败\n");
            ...
            switch (jsonObject.getInteger("ret")) {
                ...
                case 600:
                    ...
                    break;
                default:
                    sb.append("道聚城签到失败！").append(jsonObject.getJSONObject("modRet").getString("msg")).append("\n");
            }
        }
    ...
    public String qPetSign(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        if (ret == null) return "大乐斗领礼包失败";
            ...
            return "大乐斗" + jsonObject.getString("ContinueLogin") + jsonObject.getString("DailyAward");
        ...
        switch (jsonObject.getInteger("retcode")) {
            case 0: {
                if (jsonObject.getJSONObject("result").getInteger("add_hearts") == 0)
                    ...
                    sb.append("成功领取爱心 + ").append(jsonObject.getJSONObject("result").getInteger("add_hearts")).append("，");
                break;
            }
            case 100000:
                sb.append("领取爱心失败，请更新QQ！");
            default:
                sb.append("领取爱心失败！");
        }
    ...
    public String motionSign(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        switch (jsonObject.getInteger("code")) {
            case 0:
                return "QQ运动打卡成功！QQ成长值+0.2天！";
            case -10001:
                return "今天步数未达到打卡门槛，再接再厉！";
            case -10003:
                return "QQ运动今日已打卡！";
            case -1001:
                return "QQ运动打卡失败！请更新QQ！";
            default:
                return "QQ运动打卡失败！" + jsonObject.getString("emsg");
        }
    }
    ...
    public String blueSign(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        if (result.getCode() == 200) {
            ...
            switch (jsonObject.getInteger("result")) {
                case 0:
                    sb.append("蓝钻签到成功！当前签到积分").append(jsonObject.getString("SignScore")).append("点\n");
                    break;
                case 1000005:
                    sb.append("蓝钻签到失败，请更新QQ！！\n");
                    break;
                default:
                    sb.append("蓝钻签到失败！").append(jsonObject.getString("resultstr"));
            }
            ...
            switch (jsonObject.getInteger("result")) {
                case 0:
                    ...
                    break;
                case 1000005:
                    sb.append("蓝钻抽奖失败！请更新QQ！\n");
                    break;
                case 102:
                    sb.append("蓝钻抽奖次数已用完！\n");
                    break;
                default:
                    sb.append("蓝钻抽奖失败！").append(jsonObject.getString("resultstr")).append("\n");
            }
            ...
            switch (jsonObject.getInteger("result")) {
                case 0:
                    ...
                    break;
                case 1000005:
                    sb.append("蓝钻手机签到失败！请更新QQ！");
                    break;
                default:
                    sb.append("蓝钻抽奖失败！").append(jsonObject.getString("resultstr"));
            }
            return sb.toString();
    ...
    public String sendFlower(QQLoginEntity qqLoginEntity, Long qq, Long group) throws IOException {
        ...
        switch (jsonObject.getInteger("ec")) {
            ...
            case 20000:
                return "鲜花不足，充点钱再送把！";
            default:
                return "送花失败，" + jsonObject.getString("em");
        }
    }
    ...
    public String diyBubble(QQLoginEntity qqLoginEntity, String text, String name) throws IOException {
        ...
        if (result.getCode() == 200) {
            ...
            if (id != null) {
                ...
                switch (jsonObject.getInteger("ret")) {
                    case 0:
                        return "更换气泡成功，由于缓存等原因，效果可能会在较长一段时间后生效！";
                    case -100001:
                        return "更换气泡失败，请更新QQ！";
                    case 5002:
                    case 2002:
                        return "您不是睾贵的超级会员用户，更换气泡失败！";
                    default:
                        return "更换气泡失败，" + jsonObject.getString("msg");
                }
        ...
        if (response.code() == 200) {
            ...
            switch (jsonObject.getInteger("ret")) {
                ...
                case -3000:
                    return "打卡失败！！！请更新QQ！！";
                case -200:
                    return "打卡失败！！可能未获得测试资格";
                default:
                    return "打卡失败" + jsonObject.getString("msg");
            }
        } else {
            response.close();
            return "打卡失败！！！请售后再试！！";
    ...
    public String vipGrowthAdd(QQLoginEntity qqLoginEntity) throws IOException {
        ...
        if (jsonObject.getInteger("ecode") == 0) {
            ...
            for (Object obj : jsonArray) {
                JSONObject singleJsonObject = (JSONObject) obj;
                if (!simpleDateFormat.format(new Date(Long.parseLong(singleJsonObject.getString("acttime") + "000"))).equals(nowDate))
                    break;
                String type;
                switch (singleJsonObject.getInteger("actid")) {
                    ...
                    case 697:
                    case 703:
                        type = singleJsonObject.getString("actname");
                        break;
                    case 26:
                        type = "活动赠送";
                        break;
    ...
    public String publishNotice(QQLoginEntity qqLoginEntity, Long group, String text) throws IOException {
        ...
        switch (jsonObject.getInteger("ec")) {
            case 0:
                return "发公告成功！！";
            case 35:
                return "我还不是管理员呢，不能发送公告！";
            case 1:
                return "发送公告失败，请更新QQ！";
            default:
                return "发公告失败，" + jsonObject.getString("em");
        }
    }
    ...
    public String getGroupLink(QQLoginEntity qqLoginEntity, Long group) throws IOException {
        ...
        switch (jsonObject.getInteger("ec")) {
            ...
            case 1:
                return "获取链接失败，请更新QQ！！";
            default:
                return "加群链接获取失败，" + jsonObject.getString("em");
        }
    }
        ...
        if (!"错误提示".equals(Jsoup.parse(str).getElementsByTag("title").first().text())) {
            ...
            if (jsonObject.getInteger("ret") == 0) {
                ...
                switch (resultJsonObject.getInteger("ret")) {
                    case 0:
                        sb.append("微视服务加速成功！成长值+0.5天");
                        break;
                    case 2007:
                        sb.append("微视服务今天已完成加速！");
                        break;
                    default:
                        sb.append("微视领取任务奖励失败！").append(resultJsonObject.getString("err_msg"));
                }
            } else {
    ...
    private Result<List<Map<String, String>>> getGroupFileList(QQLoginEntity qqLoginEntity, Long group, String folderName, String folderId) throws IOException {
        ...
        switch (jsonObject.getInteger("ec")) {
            ...
            case -107:
                return Result.failure("获取群文件失败，您还没有加入该群！！", null);
            case 4:
            case 1:
                return Result.failure("获取群文件失败，请更新QQ！", null);
            default:
                return Result.failure("获取群文件失败" + jsonObject.getString("em"), null);
        }
    }
    ...
    public String allShutUp(QQLoginEntity qqLoginEntity, Long group, Boolean isShutUp) throws IOException {
        ...
        switch (jsonObject.getInteger("ec")) {
            ...
            case 4:
                return "执行失败，请更新QQ！！";
            default:
                return "执行失败，" + jsonObject.getString("em");
        }
    }
    ...
    public Result<List<GroupMember>> groupMemberInfo(QQLoginEntity qqLoginEntity, Long group) throws IOException {
        ...
        switch (jsonObject.getInteger("ec")) {
            case 0:
                ...
                return Result.success(list);
            case 4:
                return Result.failure("查询失败，请更新QQ！！", null);
            default:
                return Result.failure("查询失败，" + jsonObject.getString("em"), null);
        }
    }
