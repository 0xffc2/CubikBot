...
public class MenuController {
    ...
    private String userAvailableCommands = "【help】获取可用指令！\n" +
            ...
            "【几点了】让机器人报时\n" +
            "【窥屏检测】看看都有谁在窥屏！需要管理打开\n" +
            "【草】稻草人模式，消息开头为\"草\"的时候机器人会回复\"稻 草 人\"，需要管理打开\n" +
            "【色图】获取图片，需要管理打开\n" +
            "【看美女】获取图片，需要管理打开\n" +
            "【cosplay】获取图片，需要管理打开\n" +
            "【写真】获取图片，需要管理打开\n";
    private String adminAvailableCommands = "管理可以使用所有user权限组的指令！输入【help】查看\n" +
            ...
            "【撤回通知 {status}】窥屏检测功能开关！\n" +
            "【图片 {status}】图片功能开关！\n" +
            "【图片限时 {start} {end}】图片功能限时，start为开始时间，end为结束时间，时间格式为：HH:mm，如果两个时间一样即为不限时\n" +
            "【撤回通知 {status}】通知是否有消息撤回！\n" +
            "【闪照通知 {status}】通知是否有闪照发送！\n" +
            "【稻草人 {status}】通知是否有闪照发送！\n" +
            "【复读机 {status}】复读机功能开关！\n";
